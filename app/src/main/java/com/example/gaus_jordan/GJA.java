...
/**
 * Die Klasse GJA dient zur L�sung von linearen Gleichungssystemen (LGS).
 * 
 * Dazu stellt die Klasse Funktionen zur Durchf�hrung des Gau�-Algorithmus und
 * des Gau�-Jordan-Algorithmus sowie weitere Hilfsfunktionen bereit.
 * 
...
public class GJA {
	...
	/**
	 * F�gt der Trace Tabelle Text hinzu.
	 * 
	 * @param z Zeile f�r Trace Tabelle
	 */
	...
	/**
	 * F�gt der Trace Tabelle eine Zeile hinzu.
	 * 
	 * @param z Zeile f�r Trace Tabelle
	 */
	...
	/**
	 * F�gt der Trace Tabelle eine Textdarstellung einer EKM zu.
	 * 
	 * @param m EKM
	 */
	...
	/**
	 * F�gt der Trace Tabelle ein Trennzeichen zu.
	 * 
	 * @param m EKM
	 */
	...
	/**
	 * Kombiniert Zeile mit allen Nachfolger- oder Vorg�ngerzeilen
	 * 
	 * @param m   EKM
	...
	/**
	 * Checkt eine �berbestimme EKM vorliegt
	 * 
	 * @param m EKM
	 * @return Ergebnis Ja/Nein
	 */
	...
	/**
	 * F�hrt den Gau�-Algorithmus zum L�sen von LGS durch.
	 * 
	 * @param m EKM
	...
	/**
	 * F�hrt den Gau�-Jordan-Algorithmus zum L�sen von LGS durch.
	 * 
	 * @param m EKM
	...
	public double[][] gaussjordanAlg(double[][] m) {
		m = gaussAlg(m); // F�hre Gauss-Alg durch
		if (m != null) {
			// Trace Start
			addTraceL();
